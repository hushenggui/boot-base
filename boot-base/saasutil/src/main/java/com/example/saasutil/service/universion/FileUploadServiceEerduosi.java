 ...
 **/
public class FileUploadServiceEerduosi {
  ...
  public static void main(String[] args) {
    ...
    String pdfName = "EP202303810024104130.pdf";
    String orderId = "10110101506002023032311372239895";
    ...
    File tempFile = new File("E:\\hengyang\\eerduosi\\" + pdfName);
    ...
    vo.setFileUrl("https://eeds-jy.gongbao.cn/upload/" + pdfName);
