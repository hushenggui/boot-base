 ...
 *
 **/
public class FileUploadServiceMeishan {
  ...
  public static void main(String[] args) {
    ...
    String pdfName = "1202222190056047199.ofd";
    String orderId = "10110105114002022110714110983538";
    ...
    File tempFile = new File("E:\\hengyang/meishan/" + pdfName);
    ...
    vo.setFileUrl("https://meishan-jy.gongbaojin.com/upload/" + pdfName);
