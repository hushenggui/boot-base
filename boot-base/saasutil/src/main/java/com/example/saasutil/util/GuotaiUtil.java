...
public class GuotaiUtil {
  ...
  public static void main1(String[] args) throws Exception {
    ...
    byte[] signHash = SM3Util.hash(sortparam.getBytes(StandardCharsets.UTF_8));
  ...
  public static String encode(Object req, String appkey, String appsecret) {
    try {
      ...
      byte[] signHash = SM3Util.hash(param.getBytes(StandardCharsets.UTF_8));
      StringBuilder signature = new StringBuilder();
      for (byte b : signHash) {
        signature.append(byteToHexString(b));
      }
...
//      System.out.println(new String(contentByte, StandardCharsets.UTF_8));
//      System.out.println(new String(contentByte2, StandardCharsets.UTF_8));
    } catch (Exception e) {
